...
# SECRET_KEY təyin et (əgər environment-də yoxdursa)
if [ -z "$SECRET_KEY" ]; then
    export SECRET_KEY="default-secret-key-for-development-12345"
    echo "SECRET_KEY environment-də tapılmadı, default istifadə edilir"
fi
